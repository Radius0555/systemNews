...
class __TwigTemplate_aeb6c79a10fe452145478acedb302c3d extends Template
{
    private $source;
    private $macros = [];
...
{% block body %}
    <h1>Error Http 500</h1>

    <p>
        Wróć na stronę <a href=\"{{ path('home') }}\">główną</a>
    </p>
{% endblock %} ", "@Twig/Exception/error500.html.twig", "/var/www/html/systemNews/templates/bundles/TwigBundle/Exception/error500.html.twig");
    }
}
