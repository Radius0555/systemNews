...
class __TwigTemplate_c3c10292989bca0371902348bac74350 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 4
        echo "    <h1>Error Http 404</h1>

    <p>
        Wróć na stronę <a href=\"";
        // line 7
...
{% block body %}
    ...
    <p>
        Wróć na stronę <a href=\"{{ path('home') }}\">główną</a>
    </p>
{% endblock %} ", "@Twig/Exception/error404.html.twig", "/var/www/html/systemNews/templates/bundles/TwigBundle/Exception/error404.html.twig");
    }
}
