...
class Article extends \App\Entity\Article implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Article' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Article' . "\0" . 'title', '' . "\0" . 'App\\Entity\\Article' . "\0" . 'date', '' . "\0" . 'App\\Entity\\Article' . "\0" . 'content', '' . "\0" . 'App\\Entity\\Article' . "\0" . 'contentBig', '' . "\0" . 'App\\Entity\\Article' . "\0" . 'image', '' . "\0" . 'App\\Entity\\Article' . "\0" . 'importance', '' . "\0" . 'App\\Entity\\Article' . "\0" . 'category', '' . "\0" . 'App\\Entity\\Article' . "\0" . 'comments'];
        }
    ...
    public function getContentBig(): ?string
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getContentBig', []);

        return parent::getContentBig();
    }

    /**
     * {@inheritDoc}
     */
    public function setContentBig(string $contentBig): \App\Entity\Article
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setContentBig', [$contentBig]);

        return parent::setContentBig($contentBig);
    }
     ...
     * {@inheritDoc}
     */
    public function setImportance(int $importance): \App\Entity\Article
    {
